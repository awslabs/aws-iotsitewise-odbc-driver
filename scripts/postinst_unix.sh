...
ODBC_INSTALL_INI="$ODBC_LIB_PATH/iotsitewise-odbc-install.ini"

echo "[AWS IoT SiteWise ODBC Driver]"            > $ODBC_INSTALL_INI
echo "Description=AWS IoT SiteWise ODBC Driver" >> $ODBC_INSTALL_INI
