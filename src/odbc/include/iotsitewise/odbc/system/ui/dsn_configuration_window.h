...
#ifndef _IOTSITEWISE_ODBC_SYSTEM_UI_DSN_CONFIGURATION_WINDOW
#define _IOTSITEWISE_ODBC_SYSTEM_UI_DSN_CONFIGURATION_WINDOW
...
class DsnConfigurationWindow : public CustomWindow {
 ...
 public:
  ...
  /**
   * @copedoc iotsitewise::odbc::system::ui::CustomWindow::OnCreate
   */
  virtual void OnCreate();

  /**
   * @copedoc iotsitewise::odbc::system::ui::CustomWindow::OnMessage
   */
...
#endif  //_IOTSITEWISE_ODBC_SYSTEM_UI_DSN_CONFIGURATION_WINDOW
