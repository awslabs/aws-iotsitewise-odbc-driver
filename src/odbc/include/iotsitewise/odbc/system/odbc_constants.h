...
#ifndef _IOTSITEWISE_ODBC_SYSTEM_ODBC_CONSTANTS
#define _IOTSITEWISE_ODBC_SYSTEM_ODBC_CONSTANTS
...
#define SQL_ATTR_SWLOG_DEBUG 65536
...
#define DATABASE_AS_SCHEMA \
  iotsitewise::odbc::utility::CheckEnvVarNotSetToFalse("DATABASE_AS_SCHEMA")

#define ANSI_STRING_ONLY \
  iotsitewise::odbc::utility::CheckEnvVarSetToTrue("ANSI_STRING_ONLY")
...
#endif  //_IOTSITEWISE_ODBC_SYSTEM_ODBC_CONSTANTS
