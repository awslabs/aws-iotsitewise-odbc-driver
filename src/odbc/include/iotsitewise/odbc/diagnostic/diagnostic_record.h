...
#ifndef _IOTSITEWISE_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD
#define _IOTSITEWISE_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD
...
#endif  //_IOTSITEWISE_ODBC_DIAGNOSTIC_DIAGNOSTIC_RECORD
