...
#ifndef _IOTSITEWISE_ODBC_DIAGNOSTIC_DIAGNOSABLE_ADAPTER
#define _IOTSITEWISE_ODBC_DIAGNOSTIC_DIAGNOSABLE_ADAPTER
...
class IGNITE_IMPORT_EXPORT DiagnosableAdapter
 ...
 public:
  ...
  virtual void AddStatusRecord(SqlState::Type sqlState,
                               ...
                               iotsitewise::odbc::LogLevel::Type logLevel,
  ...
  virtual void AddStatusRecord(
      ...
      iotsitewise::odbc::LogLevel::Type logLevel =
          iotsitewise::odbc::LogLevel::Type::ERROR_LEVEL);
...
#endif  //_IOTSITEWISE_ODBC_DIAGNOSTIC_DIAGNOSABLE_ADAPTER
