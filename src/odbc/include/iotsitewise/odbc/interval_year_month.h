...
/**
 * @file
 * Declares iotsitewise::odbc::IntervalYearMonth class.
 */

#ifndef _IOTSITEWISE_ODBC_INTERVAL_YEAR_MONTH
#define _IOTSITEWISE_ODBC_INTERVAL_YEAR_MONTH
...
#endif  //_IOTSITEWISE_ODBC_INTERVAL_YEAR_MONTH
