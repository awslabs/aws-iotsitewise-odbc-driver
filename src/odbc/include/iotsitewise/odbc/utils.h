...
#ifndef _IOTSITEWISE_ODBC_COMMON_UTILS
#define _IOTSITEWISE_ODBC_COMMON_UTILS
...
using iotsitewise::odbc::Time;
using iotsitewise::odbc::Timestamp;
...
#endif  //_IOTSITEWISE_ODBC_COMMON_UTILS
