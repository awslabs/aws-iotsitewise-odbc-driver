...
#ifndef _IOTSITEWISE_ODBC_AUTHENTICATION_SAML
#define _IOTSITEWISE_ODBC_AUTHENTICATION_SAML
...
class IGNITE_IMPORT_EXPORT IoTSiteWiseSAMLCredentialsProvider {
 public:
  /**
   * Constructor.
   *
   ...
   */
  IoTSiteWiseSAMLCredentialsProvider(
...
#endif  //_IOTSITEWISE_ODBC_AUTHENTICATION_SAML
