...
#ifndef _IOTSITEWISE_ODBC_IGNITE_CURSOR
#define _IOTSITEWISE_ODBC_IGNITE_CURSOR
...
class IoTSiteWiseCursor {
 public:
   ...
   */
  IoTSiteWiseCursor(const Aws::Vector< Row > rowVec,
 ...
 private:
  IGNITE_NO_COPY_ASSIGNMENT(IoTSiteWiseCursor);
   ...
   */
  IoTSiteWiseColumn& GetColumn(uint32_t columnIdx) {
  ...
  /** Columns. */
  std::vector< IoTSiteWiseColumn > columns_;
...
#endif  //_IOTSITEWISE_ODBC_IGNITE_CURSOR
