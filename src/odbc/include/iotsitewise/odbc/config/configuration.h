...
#ifndef _IOTSITEWISE_ODBC_CONFIG_CONFIGURATION
#define _IOTSITEWISE_ODBC_CONFIG_CONFIGURATION
...
#define DEFAULT_DSN "IoT SiteWise DSN"
#define DEFAULT_DRIVER "AWS IoT SiteWise ODBC Driver"
#define DEFAULT_UID ""
#define DEFAULT_PWD ""
...
class IGNITE_IMPORT_EXPORT Configuration {
 ...
 private:
  ...
  /** The max row number in one page returned from SW */
...
#endif  //_IOTSITEWISE_ODBC_CONFIG_CONFIGURATION
