...
#ifndef _IOTSITEWISE_ODBC_CONFIG_CONNECTION_STRING_PARSER
#define _IOTSITEWISE_ODBC_CONFIG_CONNECTION_STRING_PARSER
...
class IGNITE_IMPORT_EXPORT ConnectionStringParser {
 public:
  ...
  struct Key {
    ...
    /** Max number of rows in one page returned from SW. */
...
#endif  //_IOTSITEWISE_ODBC_CONFIG_CONNECTION_STRING_PARSER
