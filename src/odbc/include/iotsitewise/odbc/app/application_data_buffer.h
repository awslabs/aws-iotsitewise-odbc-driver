...
#ifndef _IOTSITEWISE_ODBC_APP_APPLICATION_DATA_BUFFER
#define _IOTSITEWISE_ODBC_APP_APPLICATION_DATA_BUFFER

#include <ignite/common/include/date.h>
#include <ignite/common/include/common/decimal.h>
#include <iotsitewise/odbc/time.h>
#include <iotsitewise/odbc/timestamp.h>
#include <stdint.h>
...
#include "iotsitewise/odbc/interval_year_month.h"
#include "iotsitewise/odbc/interval_day_second.h"
...
class ApplicationDataBuffer {
 ...
 private:
   ...
   *
   * @param buffer The interval buffer for output
   * @param value The value retrieved from IoT SiteWise
   */
...
#endif  //_IOTSITEWISE_ODBC_APP_APPLICATION_DATA_BUFFER
