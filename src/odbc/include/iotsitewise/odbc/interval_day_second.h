...
/**
 * @file
 * Declares iotsitewise::odbc::IntervalDaySecond class.
 */

#ifndef _IOTSITEWISE_ODBC_INTERVAL_DAY_SECOND
#define _IOTSITEWISE_ODBC_INTERVAL_DAY_SECOND
...
#endif  //_IOTSITEWISE_ODBC_INTERVAL_DAY_SECOND
