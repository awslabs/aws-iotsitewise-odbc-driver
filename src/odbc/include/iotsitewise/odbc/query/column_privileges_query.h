...
#ifndef _IOTSITEWISE_ODBC_QUERY_COLUMN_PRIVILEGES_QUERY
#define _IOTSITEWISE_ODBC_QUERY_COLUMN_PRIVILEGES_QUERY
...
#endif  //_IOTSITEWISE_ODBC_QUERY_COLUMN_PRIVILEGES_QUERY
