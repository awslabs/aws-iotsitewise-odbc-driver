...
class IGNITE_IMPORT_EXPORT DataQuery : public iotsitewise::odbc::query::Query {
 ...
 private:
  ...
  /**
   * Preprocess SQL query to handle empty database qualifiers.
   * Removes patterns like "".table_name that are generated by Excel/PowerBI.
   *
   * @param originalSql Original SQL query string.
   * @return Processed SQL query string.
   */
