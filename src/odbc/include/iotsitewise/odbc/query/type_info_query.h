...
#ifndef _IOTSITEWISE_ODBC_QUERY_TYPE_INFO_QUERY
#define _IOTSITEWISE_ODBC_QUERY_TYPE_INFO_QUERY
 ...
 * Type info query.
 */
class TypeInfoQuery : public iotsitewise::odbc::query::Query {
 public:
  /**
   * Constructor.
   *
...
#endif  //_IOTSITEWISE_ODBC_QUERY_TYPE_INFO_QUERY
