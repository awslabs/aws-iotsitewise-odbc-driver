...
#ifndef _IOTSITEWISE_ODBC_QUERY_STATISTICS_QUERY
#define _IOTSITEWISE_ODBC_QUERY_STATISTICS_QUERY
 ...
 * Statistics Query.
 */
class StatisticsQuery : public iotsitewise::odbc::query::Query {
 public:
  /**
   * Constructor.
   *
...
#endif  //_IOTSITEWISE_ODBC_QUERY_STATISTICS_QUERY
