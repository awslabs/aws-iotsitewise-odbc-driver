...
#ifndef _IOTSITEWISE_ODBC_QUERY_COLUMN_METADATA_QUERY
#define _IOTSITEWISE_ODBC_QUERY_COLUMN_METADATA_QUERY
 ...
 * Query.
 */
class ColumnMetadataQuery : public iotsitewise::odbc::query::Query {
 public:
  /**
   * Constructor.
   *
 ...
 private:
  ...
  /**
   * Get columns metadata with database
   *
   * @param databaseType ResultColumn Type.
   *
   * @return Operation result.
   */
  SqlResult::Type GetColumnsWithDatabaseType(
...
#endif  //_IOTSITEWISE_ODBC_QUERY_COLUMN_METADATA_QUERY
