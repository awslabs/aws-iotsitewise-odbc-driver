...
#ifndef _IOTSITEWISE_ODBC_QUERY_SPECIAL_COLUMNS_QUERY
#define _IOTSITEWISE_ODBC_QUERY_SPECIAL_COLUMNS_QUERY
...
#endif  //_IOTSITEWISE_ODBC_QUERY_SPECIAL_COLUMNS_QUERY
