...
/**
 * @file
 * Declares iotsitewise::odbc::IgniteError class.
 */

#ifndef _IOTSITEWISE_ODBC_IGNITE_ERROR
#define _IOTSITEWISE_ODBC_IGNITE_ERROR
...
class IGNITE_IMPORT_EXPORT IgniteError : public std::exception {
 public:
  ...
  /** Failed to connect to IoT SiteWise */
  static const int IGNITE_ERR_SW_CONNECT = 102;
...
#endif  //_IOTSITEWISE_ODBC_IGNITE_ERROR
