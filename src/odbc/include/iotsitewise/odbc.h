...
#ifndef _IOTSITEWISE_ODBC_ODBC
#define _IOTSITEWISE_ODBC_ODBC
 ...
 * @file odbc.h
 *
 * Functions here are placed to the iotsitewise namespace so there are no
 ...
 * iotsitewise::SQLAllocEnv from iotsitewise::SQLAllocHandle we can be sure
