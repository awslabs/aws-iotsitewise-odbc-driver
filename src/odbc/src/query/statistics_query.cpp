...
StatisticsQuery::StatisticsQuery(diagnostic::DiagnosableAdapter& diag,
                                 int32_t odbcVer)
    : Query(diag, iotsitewise::odbc::query::QueryType::STATISTICS),
      columnsMeta() {
  ...
  columnsMeta.push_back(ColumnMeta(sch, tbl, "TABLE_NAME", ScalarType::STRING,
                                   Nullability::NO_NULL));
  columnsMeta.push_back(ColumnMeta(sch, tbl, "NON_UNIQUE", ScalarType::INT,
                                   Nullability::NULLABLE));
  columnsMeta.push_back(ColumnMeta(sch, tbl, "INDEX_QUALIFIER",
                                   ScalarType::STRING, Nullability::NULLABLE));
  columnsMeta.push_back(ColumnMeta(sch, tbl, "INDEX_NAME", ScalarType::STRING,
                                   Nullability::NULLABLE));
  columnsMeta.push_back(
      ColumnMeta(sch, tbl, "TYPE", ScalarType::INT, Nullability::NO_NULL));
  ...
  columnsMeta.push_back(ColumnMeta(sch, tbl, sort_order_name,
                                   ScalarType::STRING, Nullability::NULLABLE));
  columnsMeta.push_back(ColumnMeta(sch, tbl, "CARDINALITY", ScalarType::INT,
                                   Nullability::NULLABLE));
  columnsMeta.push_back(ColumnMeta(sch, tbl, "PAGES", ScalarType::INT,
                                   Nullability::NULLABLE));
