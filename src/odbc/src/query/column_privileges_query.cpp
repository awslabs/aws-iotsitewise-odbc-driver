...
ColumnPrivilegesQuery::ColumnPrivilegesQuery(
  ...
  columnsMeta.push_back(ColumnMeta(sch, tbl, "COLUMN_NAME", ScalarType::STRING,
                                   Nullability::NO_NULL));
  columnsMeta.push_back(ColumnMeta(sch, tbl, "GRANTOR", ScalarType::STRING,
                                   Nullability::NULLABLE));
  columnsMeta.push_back(ColumnMeta(sch, tbl, "GRANTEE", ScalarType::STRING,
                                   Nullability::NO_NULL));
  columnsMeta.push_back(ColumnMeta(sch, tbl, "PRIVILEGE", ScalarType::STRING,
                                   Nullability::NO_NULL));
