...
const size_t IoTSiteWiseOktaCredentialsProvider::SINGLE_NUM_CHAR_REF_LENGTH = 6;
const std::string IoTSiteWiseOktaCredentialsProvider::SAML_RESPONSE_PATTERN =
    std::string(
        "<input name=\"SAMLResponse\" type=\"hidden\" value=\"(.*?)\"/>");

std::shared_ptr< Aws::Http::HttpRequest >
IoTSiteWiseOktaCredentialsProvider::CreateSessionTokenReq() {
...
std::string IoTSiteWiseOktaCredentialsProvider::GetSessionToken(
    std::string& errInfo) {
...
std::string IoTSiteWiseOktaCredentialsProvider::DecodeNumericCharacters(
...
std::string IoTSiteWiseOktaCredentialsProvider::GetSAMLAssertion(
    std::string& errInfo) {
