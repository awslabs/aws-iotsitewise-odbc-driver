...
ConnectionInfo::ConnectionInfo(const Configuration& config)
...
#ifdef SQL_DRIVER_NAME
#if defined(WIN32)
  strParams[SQL_DRIVER_NAME] = "iotsitewise.odbc.dll";
#elif defined(__APPLE__)
  strParams[SQL_DRIVER_NAME] = "libiotsitewise-odbc.dylib";
#elif defined(__linux__)
  strParams[SQL_DRIVER_NAME] = "libiotsitewise-odbc.so";
#endif  // WIN32
#endif  // SQL_DRIVER_NAME
#ifdef SQL_DBMS_NAME
  strParams[SQL_DBMS_NAME] = "AWS IoT SiteWise";
#endif  // SQL_DBMS_NAME
  ...
  // SQLBrowseConnect.
  strParams[SQL_SERVER_NAME] = "AWS IoT SiteWise";
#endif  // SQL_SERVER_NAME
