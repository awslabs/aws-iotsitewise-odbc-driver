...
using namespace iotsitewise::odbc::app;
...
BOOST_AUTO_TEST_CASE(TestPutDateToString) {
  ...
  Date date = iotsitewise::odbc::common::MakeDateGmt(1999, 2, 22);
...
BOOST_AUTO_TEST_CASE(TestPutDateToDate) {
  ...
  Date date = iotsitewise::odbc::common::MakeDateGmt(1984, 5, 27);
...
BOOST_AUTO_TEST_CASE(TestPutTimeToString) {
  ...
  Time time = iotsitewise::odbc::common::MakeTimeGmt(7, 15, 0, 123456789);
...
BOOST_AUTO_TEST_CASE(TestPutTimeToTime) {
  ...
  Time time = iotsitewise::odbc::common::MakeTimeGmt(23, 51, 1, 123456789);
...
BOOST_AUTO_TEST_CASE(TestPutTimestampToString) {
  ...
  Timestamp date = iotsitewise::odbc::common::MakeTimestampGmt(
...
BOOST_AUTO_TEST_CASE(TestPutTimestampToDate) {
  ...
  Timestamp ts = iotsitewise::odbc::common::MakeTimestampGmt(2004, 8, 14, 6, 34,
                                                            51, 573948623);
...
BOOST_AUTO_TEST_CASE(TestGetDateFromString) {
  ...
  bool success = iotsitewise::odbc::common::DateToCTm(date, tmDate);
...
BOOST_AUTO_TEST_CASE(TestGetTimeFromString) {
  ...
  bool success = iotsitewise::odbc::common::TimeToCTm(time, tmTime);
...
BOOST_AUTO_TEST_CASE(TestGetTimestampFromString) {
  ...
  bool success = iotsitewise::odbc::common::TimestampToCTm(date, tmDate);
...
BOOST_AUTO_TEST_CASE(TestGetTimestampFromDate) {
  ...
  bool success = iotsitewise::odbc::common::TimestampToCTm(ts, tmDate);
