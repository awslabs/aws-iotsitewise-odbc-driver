...
OdbcUnitTestSuite::OdbcUnitTestSuite()
  ...
  // MockIoTSiteWiseService is singleton
  MockIoTSiteWiseService::CreateMockIoTSiteWiseService();

  // setup credentials in MockIoTSiteWiseService
  MockIoTSiteWiseService::GetInstance()->AddCredential("AwsSWUnitTestKeyId",
                                                      "AwsSWUnitTestSecretKey");
}
...
OdbcUnitTestSuite::~OdbcUnitTestSuite() {
  ...
  MockIoTSiteWiseService::GetInstance()->RemoveCredential("AwsSWUnitTestKeyId");

  // destory the singleton to avoid memory leak
  MockIoTSiteWiseService::DestoryMockIoTSiteWiseService();
}
