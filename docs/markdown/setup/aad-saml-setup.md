...
17. In the `Configured permissions`, use `Add a permission` to grant Azure AD permission to sign in to IoT SiteWise. Select `Microsoft Graph` on the `Request API permissions` page.   
